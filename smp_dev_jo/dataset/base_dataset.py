...
class CustomDataset(Dataset):
    ...
    def __init__(self, data_dir,image_root, mode = 'train', transform = None, zscore=None):
        super().__init__()
        self.mode = mode
        ...
        # add
        self.data = pd.read_csv(os.path.join(self.image_root, zscore))
        self.data = set(self.data['id'].values)
    ...
    def __getitem__(self, index: int):
        ...
        if (self.mode in ('train', 'val')):
            ...
            # add
            ann_ids = list(set(ann_ids) - self.data)
